...
stages+=[assembler,scaler,labelIndexer]

pipeline = Pipeline(stages=stages)
pipelineFIT = pipeline.fit(combined_train_set)

train_data_pipeline = pipelineFIT.transform(combined_train_set)
test_data_pipeline = pipelineFIT.transform(test_set)

train_data_final= train_data_pipeline["scaled_features","label"]
test_data_final = test_data_pipeline["scaled_features","label"]
...
cvModel = crossval.fit(train_data_final)
train_data_rf = cvModel.transform(train_data_final)
test_data_rf = cvModel.transform(test_data_final)
